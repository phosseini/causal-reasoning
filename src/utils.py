...
def get_atomic_relation_templates():
    ...
    return {
        ...
        'oEffect': ['as a result, Y or others will', 'As a result, others', 1, 'social'],
        'oReact': ['as a result, Y or others feels', 'As a result, others feel', 1, 'social'],
        'oWant': ['as a result, Y or others want', 'As a result, others want', 1, 'social'],
