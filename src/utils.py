...
def get_atomic_relation_templates():
    ...
    return {
        ...
        'CapableOf': ['is/are capable of', 'capable of', 0, 'physical'],
        ...
        'HasFirstSubevent': ['BEGINS with the event/action', 'begins with the', 0, 'event'],
        ...
        'MotivatedByGoal': ['is a step towards accomplishing the goal', 'is a step towards accomplishing the goal', 0,
                            'social'],
