...
def get_atomic_relation_templates():
    ...
    return {
        'AtLocation': ['located or found at/in/on', 'located or found at/in/on', 0, 'physical'],
        'CapableOf': ['is/are capable of', 'is/are capable of', 0, 'physical'],
        ...
        'HasFirstSubevent': ['BEGINS with the event/action', 'begins with the event/action', 0, 'event'],
        'HasLastSubevent': ['ENDS with the event/action', 'ends with the event/action', 0, 'event'],
        'HasPrerequisite': ['to do this, one requires', 'To do this, one requires', 1, 'social'],
        'HasProperty': ['can be characterized by being/having', 'can be characterized by being/having', 0, 'physical'],
        'HasSubEvent': ['includes the event/action', 'includes the event/action', 0, 'event'],
        'HinderedBy': ['can be hindered by', 'can be hindered by', 0, 'event'],
        'InstanceOf': ['is an example/instance of', 'is an example or instance of', 0, ''],
        'isAfter': ['happens after', 'happens after', 0, 'event'],
        'isBefore': ['happens before', 'happens before', 0, 'event'],
        'isFilledBy': ['blank can be filled by', 'blank can be filled by', 0, 'event'],
        'MadeOf': ['is made of', 'is made of', 0, 'physical'],
        'MadeUpOf': ['made (up) of', 'made or made up of', 0, 'physical'],
        'MotivatedByGoal': ['is a step towards accomplishing the goal', 'is a step towards accomplishing the goal', 0, 'social'],
        'NotDesires': ['do(es) NOT desire', 'do not or does not desire', 0, 'physical'],
        'ObjectUse': ['used for', 'used for', 0, 'physical'],
        'UsedFor': ['used for', 'used for', 0, 'physical'],
        'oEffect': ['as a result, Y or others will', 'As a result, PersonY or others will', 1, 'social'],
        'oReact': ['as a result, Y or others feels', 'As a result, PersonY or others feels', 1, 'social'],
        ...
        'ReceivesAction': ['can receive or be affected by the action', 'can receive or be affected by the action', 0, ''],
        'xAttr': ['X is seen as', 'X is seen as', 1, 'social'],
        'xEffect': ['as a result, PersonX will', 'As a result, PersonX will', 1, 'social'],
